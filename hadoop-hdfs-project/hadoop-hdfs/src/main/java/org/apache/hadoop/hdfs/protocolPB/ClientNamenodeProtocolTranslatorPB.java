...
public class ClientNamenodeProtocolTranslatorPB
  ...
  public void abandonBlock(ExtendedBlock b, String src, String holder)
    ...
    AbandonBlockRequestProto req =
        AbandonBlockRequestProto.newBuilder().setB(PBHelper.convert(b))
            .setSrc(src).setHolder(holder).build();
    try {
  ...
  public boolean complete(String src, String clientName, ExtendedBlock last)
    ...
    CompleteRequestProto.Builder req =
        CompleteRequestProto.newBuilder().setSrc(src).setClientName(clientName);
    if (last != null) {
